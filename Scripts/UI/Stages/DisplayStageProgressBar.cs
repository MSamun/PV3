...
namespace PV3.UI.Stages
{
    public class DisplayStageProgressBar : MonobehaviourReference
    {
        ...
        {
            nonBossProgressBar.gameObject.SetActive(!ListScriptableOfStagesObject.ListOfStages[stageListIndex.Value].Stage.HasBoss);
            bossProgressBar.gameObject.SetActive(ListScriptableOfStagesObject.ListOfStages[stageListIndex.Value].Stage.HasBoss);
        }
    }
}