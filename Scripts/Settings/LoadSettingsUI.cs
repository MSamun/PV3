...
namespace PV3.Settings
{
    public class LoadSettingsUI : MonobehaviourReference
    {
        ...
        public void LoadSettingsScene()
        {
            ...
            if (!SceneManager.GetSceneByBuildIndex(4).isLoaded) SceneManager.LoadSceneAsync(4, LoadSceneMode.Additive);
        ...
        {
            if (mainScreenPanel) mainScreenPanel.gameObject.SetActive(!mainScreenPanel.gameObject.activeInHierarchy);
        }
    }
}